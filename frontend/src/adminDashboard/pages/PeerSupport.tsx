...
const [peerMentors,setPeerMentors] = useState<any[]>([])
...
setSupportGroups(res.data.supportGroups)
  ...
  return (
    <DashboardLayout>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        ...
        {[
          { label:"Active Mentors", value:stats.mentors, icon:Users, color:"text-[hsl(var(--arogyam-teal))]", bg:"bg-[hsl(var(--arogyam-teal)/0.12)]" },
          { label:"Support Groups", value:stats.groups, icon:Heart, color:"text-[hsl(var(--arogyam-coral))]", bg:"bg-[hsl(var(--arogyam-coral)/0.12)]" },
          { label:"Sessions This Week", value:stats.sessions, icon:MessageCircle, color:"text-[hsl(var(--primary))]", bg:"bg-[hsl(var(--arogyam-sky))]" },
          { label:"Avg Rating", value:stats.rating, icon:Star, color:"text-[hsl(var(--arogyam-yellow))]", bg:"bg-[hsl(var(--arogyam-yellow)/0.12)]" },
        ].map((stat)=>(
          <div key={stat.label} className="glass-card p-4 flex items-center gap-4">
