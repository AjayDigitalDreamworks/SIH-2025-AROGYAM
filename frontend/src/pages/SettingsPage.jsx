...
//           }}>
//             {form.name ? form.name.split(" ").map(n => n[0]).join("").slice(0,2) : "MI"}
//           </div>
//           <button style={{
...
//           gap: "20px"
//         }}>
//           <InputField label="Display Name" value={form.username} onChange={set("username")} />
...
//           <SelectField label="Avatar" value={form.avatar} onChange={set("avatar")} options={avtars} />
//           <SelectField label="University" value={form.university} onChange={set("university")} />
//           <SelectField label="Year of study" value={form.yearOfStudy} onChange={set("yearOfStudy")} options={yearOfStudy} />
//         </div>
//       </div>
...
function InputField({ label, value, onChange, type = "text" }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
      <label style={{ fontSize: "12.5px", fontWeight: 600, color: "#6b5ea8" }}>
        {label}
      </label>
  ...
  return (
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div>
          <h2 style={{ fontSize: "17px", fontWeight: 700, color: "#2d1b69", margin: 0 }}>
            Profile Settings
          </h2>

          <p style={{ fontSize: "13px", color: "#9b8ec4", marginTop: "3px" }}>
...
function PrivacySecurityCard() {
  return (
    <div style={{
      ...
      <p>Password change section already present in your code.</p>
    </div>
  );
}
    ...
    <div style={{
      ...
      <div style={{
        ...
        <main style={{
          ...
          <div style={{ marginBottom: "24px" }}>
            <h1 style={{ fontSize: "22px", fontWeight: 800, color: "#2d1b69" }}>
              Settings
            </h1>

            <p style={{ fontSize: "13.5px", color: "#9b8ec4" }}>
